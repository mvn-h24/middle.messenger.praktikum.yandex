...
import {TestProfile} from "@/entity/user/fixture/test-profile.js";
...
const slot = html`
    <div class="${cn.profileView}">
        ...
        <div class="${cn.profileView__controlList}">
            <div class="listItem"><a class="${cn.profileView__link} appLink" href="/profile/edit/">Изменить данные</a></div>
            <div class="listItem"><a class="${cn.profileView__link} appLink" href="/profile/change-password/">Изменить пароль</a></div>
            <div class="listItem"><a class="${cn.profileView__link} appLink appLink--warning" href="/login/">Выйти</a></div>
        </div>
    </div>
`;
